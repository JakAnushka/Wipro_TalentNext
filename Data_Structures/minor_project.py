'''Project:1 Create a dictionary that contains a list of people and one interesting fact about each of them.
...
for person, fact in people_facts.items():
    print(f"{person}: {fact}")
'''Project:2 Given the participant's score sheet for your University Sports Day, you are required to find the runner-up score. You have scores. Store them in a list and find the score of the runner-up.
...
'''Project:3 You have a record of n students. Each record contains the student's name, and their percent marks in Math, Physics and Chemistry. The marks can be floating values. You are required to save the record in a dictionary data type.
...
Sample input: ("Krishna" (67, 68, 691,
